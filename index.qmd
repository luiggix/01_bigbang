...
## En el principio {background-color="black" background-image="./figures/fire.jpg" background-size="cover" background-opacity="0.85"}
...
## Enseguida {background-color="black" background-image="./figures/atoms_into.jpg" background-size="cover" background-opacity="0.75"}
...
## Y luego {background-color="black" background-image="./figures/In_a_planet_called_Earth.jpg" background-size="cover" background-opacity="0.65"}
...
## No hace mucho {background-color="black" background-image="./figures/homo_sapiens_village.jpg" background-size="cover" background-opacity="0.45"}

::::{.incremental}

* <font style="font-size:60px;">70,000 años ...</font>
* <font style="font-size:50px;">Una especie de organismos complejos, conocidos como *homo sapiens* formaron estructuras mucho más elaboradas ... </font>

    - <font style="font-size:50px;">**Culturas**.</font>
...
## Regresemos un poco {background-color="black" background-image="./figures/Milky_Way.jpg" background-size="cover" background-opacity="0.85"}
...
## *Homo deus* {background-color="black" background-image="./figures/homodeus.png" background-size="cover" background-opacity="0.5"}

::: {.incremental}

<font color="Azure" style="font-size:45px;">
...
> * <font color="Khaki" style="font-size:40px;">[James Flyn](https://en.wikipedia.org/wiki/James_Flynn_(academic)) estudió la evolución del cociente intelectual (CI).</font>
* <font color="Khaki" style="font-size:40px;">El CI de la humanidad creció en 30 puntos durante el siglo XX.</font>
* <font color="Khaki" style="font-size:40px;">***Efecto Flyn***: aumento sostenido de la inteligencia.</font>
* <font color="Khaki" style="font-size:40px;"> Flyn murió en 2020, justo cuando se descubrió que el CI estaba disminuyendo.</font>
...
> * <font color="Khaki" style="font-size:33px;">Ante una amenaza de vida o muerte, los antiguos homínidos se ponían de acuerdo. </font>
* <font color="Khaki" style="font-size:33px;">La vida social les permitió aumentar su capacidad cognitiva.</font>
* <font color="Khaki" style="font-size:33px;">[Pablo Rudomín](https://es.wikipedia.org/wiki/Pablo_Rudom%C3%ADn) distingue entre inteligencia individual e inteligencia social; la segunda va en decaimiento.</font>
> * <font color="Khaki" style="font-size:33px;">El panorama empeora al hacer otra comparación: el CI decae al tiempo que la inteligencia artificial mejora. </font>

:::{.r-stack}
<font style="font-size:33px;">(Villoro, J., 2024)</font>
:::

. . .

<font style="font-size:30px;">[P(doom)](https://en.wikipedia.org/wiki/P(doom)): probabilidad de resultados existencialmente catastróficos debidos a la IA.</font>
...
* Desarrollada por Gustav Freytag en 1863.
* Estructura narrativa de cinco actos que organiza la tensión dramática. 
* Utilizada para analizar tragedias clásicas y shakesperianas.
...
* El tablero **no es una colección de gráficas**. 
    - Es una historia que el usuario *vive* mientras se desplaza en las diferentes secciones. 

. . . 

* Cada sección corresponde a una etapa de la pirámide de Freytag. 
    - La transición entre ellas debe sentirse como un giro emocional, no como un cambio de pestaña.
...
>* <font color="Khaki" style="font-size:32px;">Una buena divulgación [...] ilustra ideas a través de historias de gente [...] se basa en técnicas de la escritura literaria.</font>
* <font color="Khaki" style="font-size:32px;">*creative nonfiction*: historias reales bien contadas.</font>

. . . 

Buena divulgación:

> * <font color="Khaki" style="font-size:32px;">Cuidan el estilo y complementan los resultados científicos con anécdotas, se organizan como argumentos lógicos y/o narraciones.</font>
* <font color="Khaki" style="font-size:32px;">Evitan acomplejar al lector esquivando discretamente el lenguaje técnico y no suenan a artículos científicos.</font>
